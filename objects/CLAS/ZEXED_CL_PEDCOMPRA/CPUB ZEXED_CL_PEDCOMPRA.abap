...
*             INCLUDE TYPE zexed_scm_purchase_order=>tys_purchase_order_item_type.
                 INCLUDE TYPE zexed_scm_purchase_order_ceec=>tys_purchase_order_item_type.
*    TYPES:   pur_ord_account_assignment TYPE TABLE OF zexed_scm_purchase_order=>tys_purchase_order_account_a_2 WITH EMPTY KEY,
        TYPES:   pur_ord_account_assignment TYPE TABLE OF zexed_scm_purchase_order_ceec=>tys_purchase_order_account_a_2 WITH EMPTY KEY,
               END OF ty_api_item.

        TYPES: BEGIN OF ty_api_header.
*             INCLUDE TYPE zexed_scm_purchase_order=>tys_purchase_order_type.
                 INCLUDE TYPE zexed_scm_purchase_order_ceec=>tys_purchase_order_type.
