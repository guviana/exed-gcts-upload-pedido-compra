...
*                                                 proxy_model_id      = 'ZEXED_SCM_PURCHASE_ORDER'
                                                     proxy_model_id      = 'ZEXED_SCM_PURCHASE_ORDER_CEEC'
        ...
        LOOP AT it_deep ASSIGNING FIELD-SYMBOL(<fs_header>).
          ...
          TRY.
              ...
              APPEND VALUE #(
                  ...
                  language                = 'P'
                  "***CUSTOM FIELDS***
                  yy_1_prazo_header_pdh         = <fs_header>-Yy1PrazoHeaderPdh
                  yy_1_departamento_heade_pd    = <fs_header>-Yy1DepartamentoHeadePd
                  yy_1_rir_pdh                  = <fs_header>-Yy1RirPdh
              ) TO lt_api_header
...
*          base_unit                        = <fs_item>-BaseUnit
                  ...
                  purchase_contract                = <fs_item>-PurchaseContract
...
*    " Set the properties of the Header node
                  lo_data_desc_node_so->set_properties(
                    VALUE #(
                      ...
                      ( |PAYMENT_TERMS| )
                      ( |LANGUAGE| )
                      ( |YY_1_PRAZO_HEADER_PDH| )       "***CUSTOM FIELDS***
                      ( |YY_1_DEPARTAMENTO_HEADE_PD| )  "***CUSTOM FIELDS***
                      ( |YY_1_RIR_PDH| )                "***CUSTOM FIELDS***
                    )
                  ).
