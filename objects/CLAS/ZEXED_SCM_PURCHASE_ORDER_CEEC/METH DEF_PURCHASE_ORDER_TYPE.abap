  METHOD def_purchase_order_type.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_RIR_PDH' ).
    lo_primitive_property->set_edm_name( 'YY1_RIR_PDH' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.

    lo_primitive_property = lo_entity_type->get_primitive_property( 'YY_1_DEPARTAMENTO_HEADE_PD' ).
    lo_primitive_property->set_edm_name( 'YY1_DEPARTAMENTO_HEADE_PDH' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
